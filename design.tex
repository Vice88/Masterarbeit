...
\textbf{small signal equivalent circuit for load transistor. this already shows the behavior of the load impedance}
\textit{Max Gain with output amp - to tune the quiescent point, get the right impdenace}
