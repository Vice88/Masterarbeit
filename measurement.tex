...
% which value for Vdd? 5V ? 15V ?
% if 5V -> Ratio of probe de embedded? -> factor 10

% es koennte sein dass die transistoren nicht richtig durchschalten, da vds zu gering ist. --> Messung wiederholen und verbessern
% ausrechnen, simulieren was für ein Vtreshold für Vds besteht.
