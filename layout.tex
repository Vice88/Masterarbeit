...
The values of the used capacitors in the order of placement starting at the chip supply in the middle of the substrate.
\begin{enumerate}
	\item 82p
	\item 1n
	\item 10n
...
\begin{figure}[htb!]
	\centering
  \includegraphics{Layout_DDRiXY6_bonds_new_grey_edited.pdf}
