...
\begin{figure}[htb!]
	\centering
  \includegraphics{Photo_DDRi_XY6.pdf}
...
\begin{figure}[htb!]
	\centering
  \includegraphics{Photo_DDRi_2C.pdf}
...
%\textbf{length of the bonds, number of bonds, thickness of bonds ask Dirk Meder. A lot of vias - more inductance - voltage drop between layers. short as possible lines, no rects - para caps in the edge. first filter cap to supply pin near the chip. number and cap size determined on experience. }
